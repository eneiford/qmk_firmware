 ...
 * |   SHIFT ( |     |     |     |     |     |     |     |  <  |  >  |     |   SHIFT  )      |
 * | ----------------------------------------------------------------------------------------|
 * |  CTRL |  ALT  | CMD  | BACKSPACE| _VIM  |      SPACE      |  ALT  | CMD  | CTRL | _RGB  |
 * `-----------------------------------------------------------------------------------------'
*/		
	...
	[_VIM] = LAYOUT_60_ansi_split(
	    ...
	    KC_LSPO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_LT, KC_GT, KC_NO, KC_RSPC, 
	    KC_LCTL, KC_LALT, KC_LGUI, KC_BSPC, KC_TRNS, KC_SPC, KC_RALT, KC_RGUI, KC_RCTL, MO(3)
	),
 /* _RGB LAYER
 *
 * ,-----------------------------------------------------------------------------------------.
